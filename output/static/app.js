...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vuex = __webpack_require__(84);
	var storeObj = __webpack_require__(91);
	__webpack_require__(92);
	Vue.use(__webpack_require__(77));
	Vue.use(VueRouter);
	Vue.use(Vuex);
	...
	var app = new Vue({
	    ...
	    store: store,
	    data: {
	        myData: [{ "name": "luwnewei" }, { "name": "haungsihong" }],
	        name: "vue"
	    },
	    methods: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageA = function pageA(resolve) {
	    __webpack_require__.e/* nsure */(1, function () {
	        resolve(__webpack_require__(78));
	    });
	};
	var pageB = function pageB(resolve) {
	    __webpack_require__.e/* nsure */(2, function () {
	        resolve(__webpack_require__(86));
	    });
	};
	var Vue = __webpack_require__(2);
	var beforeEnter = __webpack_require__(6);
	Vue.use(__webpack_require__(77));
	var routes = [{
	    path: '/pageA',
	    component: pageA,
	            ...
	            return _regenerator2.default.wrap(function _callee$(_context) {
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            _context.next = 6;
	                            return Vue.http.get("./app/myInfo.json");
	                        ...
	                        case 6:
	                            ...
	                            _context.next = 10;
	                            return Vue.http.get("./app/constants.json");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dateRange = Vue.extend({
	    ...
	    "mounted": function mounted() {
	        var self = this;
	        var fn = function fn(event, begin, end) {
	            this.dateRange = {
	                "begin": begin,
	                "end": end
	            };
